...
const Eur1Cent90 = Money.EUR(1, 90)
const Eur1Cent10 = Money.EUR(1, 10)
describe('Money', () => {
    describe('times', () => {
        it('times 1', () => {
        ...
        it('times 2, when no cents', () => {
            ...
            expect(Eur1Cent10.times(2)).to.eql( Money.EUR(2, 20))
        })
        it('when cents > 100', () => {
            expect(Eur1Cent90.times(2)).to.eql( Money.EUR(3, 80))
        })
    })
})
